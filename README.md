...
An implementation of **`Tenzies Game`** in `ReactJS`. While creating this project I learned about `Event Listeners`, `React State`, `Conditional Rendering`, `React Hooks(useEffect)`, and more. 
